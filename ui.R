...
ui <- dashboardPage(
  ...
  skin = 'green', # Set default skin color here
  
  dashboardHeader(title='FungiTrackR'),  # set header text
      ...
      tabPanel("Table",
               ...
               pickerInput(
                 ...
                 choices =  c("None", "Original", 
                              "Filtered", "Selected Variables", "Grouped", "Filtered & Selected"),
                 selected = "Original",
                 options = list(
                   style = "btn-primary")
               ),
  ...
  dashboardFooter(left = "Contact: bcroker@health.ucsd.edu"),
)
